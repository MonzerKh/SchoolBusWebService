...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20220107095043_Student_BusRelation")]
    partial class Student_BusRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelsLayer.DataLayer.Tables.Student_Bus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ModelsLayer.DataLayer.Tables.Student_Bus", b =>
                {
                    b.HasOne("ModelsLayer.DataLayer.Tables.Bus", "Bus")
                        .WithMany("Bus_Students")
                        .HasForeignKey("Bus_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ModelsLayer.DataLayer.Tables.Student", "Student")
                        .WithMany("Student_Buses")
